    ...
    <Layout>
      <div className="flex flex-col w-full h-[50vh] items-center bg-gray-100 rounded">
        <div className="relative w-full max-w-xl h-full flex flex-col items-center justify-center">
          ...
          <div className="buble__1 opacity-75 absolute top-2 -z-1 right-[15%] w-36 h-36 bg-yellow-200 rounded-full filter blur-xl animate-blob mix-blend-multiply"></div>
          <div className="buble__1 opacity-75 absolute top-[20%]  -z-1 left-[30%] w-36 h-36 bg-pink-300 rounded-full filter blur-xl animate-blob2"></div>
